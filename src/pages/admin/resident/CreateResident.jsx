...
import { 
  ...
  FaBuilding, FaEye, FaEyeSlash, FaKey
} from 'react-icons/fa';
...
const CreateResident = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/admin/residents`, submitData, {
        headers: { Authorization: `Bearer ${token}` }
      });

      if (response.data.success) {
        toast.success('Resident created successfully!');
        navigate('/admin/residents', { state: { message: 'Resident created successfully!' } });
      }
    } catch (error) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white">Add New Resident</h1>
          <p className="text-text-muted text-sm mt-1">Register a new resident in the society.</p>
        </div>
        <Link to="/admin/residents" className="btn-secondary flex items-center gap-2 px-4 py-2 text-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input 
                ...
                maxLength="30"
                className={`w-full px-4 py-2 bg-primary-light/50 border ${errors.firstName || serverErrors.firstName ? 'border-red-400' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-accent transition-colors`} 
                placeholder="Ahmed" 
              />
              {(errors.firstName || serverErrors.firstName) && <p className="error-text text-red-400 text-xs mt-1">{errors.firstName || serverErrors.firstName}</p>}
            </div>
            <div>
              ...
              <input 
                ...
                onChange={handleChange} 
                maxLength="30"
                className={`w-full px-4 py-2 bg-primary-light/50 border ${errors.lastName ? 'border-red-400' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-accent transition-colors`} 
                placeholder="Ali" 
              />
        ...
        <div className="glass-card p-6">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <FaHome className="text-accent" /> Flat Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange} 
                maxLength="10"
                className={`w-full px-4 py-2 bg-primary-light/50 border ${errors.flatNumber || serverErrors.flatNumber ? 'border-red-400' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-accent transition-colors`} 
                placeholder="101" 
              />
        ...
        <div className="glass-card p-6">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <FaUserFriends className="text-accent" /> Family & Emergency
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange} 
                maxLength="50"
                className={`w-full px-4 py-2 bg-primary-light/50 border ${errors.emergencyContact ? 'border-red-400' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-accent transition-colors`} 
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange} 
                maxLength="15"
                className={`w-full px-4 py-2 bg-primary-light/50 border ${errors.emergencyPhone ? 'border-red-400' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-accent transition-colors`} 
        ...
        <div className="glass-card p-6">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <FaCar className="text-accent" /> Vehicle Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
        ...
        <div className="glass-card p-6">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
            <FaIdCard className="text-accent" /> Additional Information
          </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-end">
          <Link to="/admin/residents" className="flex items-center justify-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 rounded-xl text-white transition-all duration-300">
            <FaTimes /> Cancel
          </Link>
          <button 
            type="submit" 
